(function() {
  ...
  if (typeof window.links === 'undefined' || !Array.isArray(window.links)) {
    console.error('ERRO: window.links não definido ou não é array.');
    categoriesContainer.innerHTML = `
      <div style="text-align:center; padding:40px; color:#f85149; background:#161b22; border-radius:12px; border:1px solid #f85149;">
        ...
        Certifique-se de que o arquivo <code>links.js</code> está presente e contém <code>window.links</code> com um array.
      </div>
    `;
    return;
  }
